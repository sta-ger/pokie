...
## Persistent-harness recovery closeout (2026-08-23)

The product content remains candidate `49d5fccc517f5a7f964ecc7fa32148edeb18d588`; the clean read-only companion remains exactly `b7b043e0e722da917f1b60c4f107c8cc35fdd725`.  A candidate build completed, then four fresh isolated Studio launches used only `node ./dist/cli/pokie.js --no-open` and the controller-supplied persistent harness.
