...
async function main() {
    ...
    await snapshot("21-studio-play-seeded-round"); await assertSurface("Studio Play");
    ...
    await snapshot("22-studio-replay-seeded-round"); await assertSurface("Studio Replay");
    ...
    note("PASS: all four public rendered surfaces agree and satisfy the full-paytable/post-round-credits criteria. No DOM/state injection or application API call was used.");
