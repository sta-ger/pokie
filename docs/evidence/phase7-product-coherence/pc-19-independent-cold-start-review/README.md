...
```sh
node scripts/pc-19-independent-cold-start-review.mjs --review-dir /absolute/path/to/run
```
...
artifact ledger, a hash-bound frozen blind finding list, post-freeze comparison,
