import {describeReportsList} from "../../../../../../cli/studio-client/src/domain/interpret/Reports";
import type {StudioSimulationReportListEntry} from "../../../../../../cli/studio-client/src/api/types";
