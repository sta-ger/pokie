import {describeBuildPreview, describeBuildResult} from "../../../../../../cli/studio-client/src/domain/interpret/Home";
import type {StudioBuildPreviewView, StudioBuildResult} from "../../../../../../cli/studio-client/src/api/types";
