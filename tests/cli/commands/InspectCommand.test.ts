...
describe("InspectCommand", () => {
    ...
    it("passes the given packageRoot to the inspector", async () => {
        ...
        expect(inspector.calledWith).toBe("./sample-slot");
    });
    ...
    it("prints game/hash/source/timestamp/pokie version/files and returns 0 for a generated package", async () => {
        ...
        expect(printed).toContain('Inspecting package at "./sample-slot"');
        expect(printed).toContain('game             Sample Slot (id: "sample-slot", v0.1.0)');
        expect(printed).toContain("package root     ./sample-slot");
        expect(printed).toContain("blueprint hash   sha256:abc123");
        expect(printed).toContain("source           sample-slot.blueprint.json");
...
describe("InspectCommand (integration, real GamePackageInspector)", () => {
    ...
    it("inspects a real package built by the current \"pokie build\" and reports it as not generated -- a built package carries no provenance metadata of its own", async () => {
