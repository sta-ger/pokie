...
// StudioArtifactBuildService.listTargets). ExportDeployTab only ever renders a "Build artifact" card once
// this is true, rather than re-deriving its own ProjectType/capability rule -- see ExportDeployTargets.ts's
// own doc comment for why that duplication is exactly what this endpoint exists to remove.
