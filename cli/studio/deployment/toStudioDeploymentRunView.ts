...
// only real transform is content-decoding each generated artifact's own `content` (string | Buffer)
// into a plain string. This function never re-derives, re-checks, or second-guesses anything
// ExternalDeploymentService already computed — see StudioDeploymentService's own doc comment for why
// that matters.
