...
// specific-but-not-yet-supported ProjectType (e.g. an ordinary .wasm file with no POKIE component contract)
// throws an explicit unsupported-target error rather than reporting undefined; and a target
