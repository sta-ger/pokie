...
// conversion and has no general meaning across arbitrary external targets. See
// docs/external-adapter-sdk.md#why-stake-engine-export-isnt-an-externaldeploymenttarget for why this
// exclusion is deliberate, not a gap to close.
